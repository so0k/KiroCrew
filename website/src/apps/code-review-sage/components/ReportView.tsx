        ...
        >
          ...
          <span className="flex-1 min-w-0">
            ...
            <span className="mt-1.5 flex flex-wrap items-center gap-1.5">
              <Pill>{i18nT('apps.codeReviewSage.components.reportView.design')} {row.design_risk}</Pill>
              <Pill>{i18nT('apps.codeReviewSage.components.reportView.blast')} {row.blast}</Pill>
              {row.red > 0 && (
            ...
            {row.why && (
              <span className="mt-1.5 block text-[12px] text-muted">{row.why}</span>
            )}
          </span>
          {hasDetail && (
            <ChevronRight
          ...
          {findings.map((f, i) => {
            ...
            return (
              <FindingCard
                ...
                label={[f.dimension, f.file].filter(Boolean).join(' on ')}
        ...
        {selectedCount > 0 && onPostSelection ? (
          <span className="inline-flex items-center gap-2">
            ...
            >
              ...
              {i18nT('apps.codeReviewSage.components.reportView.post')} {selectedCount} {i18nT('apps.codeReviewSage.components.reportView.selected')}
            </button>
            <button
              type="button"
