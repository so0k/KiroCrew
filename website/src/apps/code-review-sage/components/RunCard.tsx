  ...
  return (
    ...
    {onDelete && !confirming && (
      <button
        ...
        className="absolute top-1.5 right-1.5 rounded-md bg-card/90 p-1 text-muted opacity-0 transition-opacity group-hover:opacity-100 focus-visible:opacity-100 hover:text-danger cursor-pointer"
      >
        <Trash2 size={12} />
      </button>
    )}
